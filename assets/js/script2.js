...
document.addEventListener('DOMContentLoaded', () => {
  ...
  characters.forEach((char, index) => {
    ...
    card.innerHTML = `
      ...
      <div class="character-image" style="background-image:url('${displayImg}')"></div>
  ...
  startBtn.addEventListener('click', () => {
    ...
    localStorage.setItem('playerData', JSON.stringify({
      name: playerName,
      character: { ...selectedCharacter, portrait, image: portrait }
    }));

    showDifficultyModal(() => {
      showStory('postSelect', { name: playerName, character: { ...selectedCharacter, portrait } });
    });
  });
